...
class Chrome(webdriver.Chrome):
    ...
    def __init__(
        self, validate, proxymanager=None, type=Mode.LOCAL, headless=False, enable_image=True,
        ...
        if self.executable_path == Mode.DEFAULT:
            super(Chrome, self).__init__(executable_path=ChromeDriverManager(
    ...
    def get_shadow_root(self, driver, selector, tag):
        ...
        shadowRootID = list(self.execute_script(
            "return arguments[0].shadowRoot", e).values())[0]
    ...
    def get(self, *args, **kwargs):
        ...
        try:
            error = self.find_element_by_css_selector(
